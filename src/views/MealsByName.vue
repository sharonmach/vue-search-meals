...
<template>
  <div class="p-8 pb-0">
    <input
      type="text"
      v-model="keyword"
      class="rounded boreder-2 border-gray-200 w-full"
  ...
  <div class="grid grid-cols-1 md:grid-cols-3 gap-5 p-8">
    ...
    <router-link to="">
      <img
        ...
        :alt="strMeal"
        class="rounded-t-xl w-full h-50 object-cover"
      />
    </router-link>
     <div class="p-3">
      <h3 class="font-bold">{{ meal.strMeal }}</h3>
      <p class="mb-4">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Sequi tenetur quasi praesentium, officia ipsa delectus et quia voluptas expedita harum.</p>
      <div>
